...
Dim lColourSize As Long
   ...
   If (lR <> 0) Then
      ...
      If (SerialiseBitmap(lHDC, tII.hbmColor, False, b(), lByteStart, lColourSize, lVersion)) Then
         lByteStart = lByteStart + lColourSize
         If (SerialiseBitmap(lHDC, tII.hBmMask, True, b(), lByteStart, lMonoSize, lVersion)) Then
...
Dim lMonoSize As Long
   ...
   If (DeSerialiseBitmap(lHDC, tII.hbmColor, False, b(), lByteStart, lColourSize, lVersion)) Then
      lByteStart = lByteStart + lColourSize
      ' get the mono bitmap:
      If (DeSerialiseBitmap(lHDC, tII.hBmMask, True, b(), lByteStart, lMonoSize, lVersion)) Then
         ' Set the size:
         lArraySize = lColourSize + lMonoSize + 12
